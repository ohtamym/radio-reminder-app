...
**完了条件**:
- [ ] すべてのディレクトリが作成されている
- [ ] 各ディレクトリに `.gitkeep` または `index.ts` が配置されている
...
**完了条件**:
- [ ] DatabaseContextが実装されている
- [ ] DatabaseProviderでラップできる
- [ ] useDatabaseフックが動作する
- [ ] データベースが初期化される
